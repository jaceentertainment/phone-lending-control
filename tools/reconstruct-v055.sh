...
# GitHub transport may be split into arbitrary small parts; the reconstructed
# wrapper and decoded patch hashes are the authoritative integrity checks.
